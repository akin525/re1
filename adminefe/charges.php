...
// if userid is less than 6 char then status is not ok
                                                ...
                                                if ($status=="OK")
                                                {
                                                    ...
                                                    $queryd=mysqli_query($con,"insert into deposit (status, username, amount, payment_ref, iwallet, fwallet) values (1,'$receiver', '$amount', 'charge_.$refid', '$ubalance', '$fwallet')");
...
//                                                    $username=decryptdata($username);
                                                    ...
                                                    $subject = "$receiver|Account Being Charge | efe-$refid";
