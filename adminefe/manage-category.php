                                ...
                                <table class="table m-0 table-colored-bordered table-bordered-primary">
                                    ...
                                    while($row=mysqli_fetch_array($query))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-category.php?cid=<?php echo htmlentities($row['id']);?>"><i class="mdi mdi-pencil" style="color: #29b6f6;"></i></a>
                                                &nbsp;<a href="manage-category.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="mdi mdi-trash-can" style="color: #f05050"></i></a> </td>
                                        </tr>
                                        <?php
                                        $cnt++;
                                    } ?>
                                ...
                                <table class="table m-0 table-colored-bordered table-bordered-danger">
                                    ...
                                    while($row=mysqli_fetch_array($query))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['PostingDate']);?></td>
                                            <td><?php echo htmlentities($row['UpdationDate']);?></td>
                                            <td><a href="manage-category.php?resid=<?php echo htmlentities($row['id']);?>"><i class="mdi mdi-arrow-right-bold-box" title="Restore this category"></i></a>
                                                &nbsp;<a href="manage-category.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Delete forever"> <i class="mdi mdi-trash-can" style="color: #f05050"></i> </td>
                                        </tr>
                                        <?php
                                        $cnt++;
                                    } ?>
