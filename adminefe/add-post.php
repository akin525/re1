...
// Code for move image into directory
        ...
        echo $message = "Post successfully added";
        print "
				<script language='javascript'>
				 let message = 'Post successfully added: ';
                                    alert(message);
...
<!--           --><?php //include('includes/footer.php');?>
        ...
        <!--Summernote js-->
        <script src="/go/plugins/summernote/summernote.min.js"></script>
        <!-- Select 2 -->
        <script src="/go/plugins/select2/js/select2.min.js"></script>
        <!-- Jquery filer js -->
        <script src="/go/plugins/jquery.filer/js/jquery.filer.min.js"></script>
